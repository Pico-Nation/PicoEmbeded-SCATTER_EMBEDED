export default {
	...
	dashboard:{
		vote:{
			...
			description:`Hemos lanzado un productor de bloques PICO Mainnet que ahora puede votar. Ayúdenos a alcanzar una posición de producción votando por nosotros.`,
			button:`¡Vota ahora!`,
	...
	receive:{
		...
		forPicoio:`Algunos intercambios le pedirán una etiqueta de dirección, memo o alguna otra forma de entrada secundaria. Puede ingresar cualquier cosa en ese campo ya que esta es una cuenta real de PICOIO.`
	},
	...
	editNetwork:{
		...
		systemTokenDescription:`Algunas redes usan un token de sistema personalizado en lugar del token de sistema predeterminado (como ETH, PICO o TRX).`
	},
	...
	popins:{
		...
		overlay:{
			...
			linkAccount:{
				...
				button:`Enlazar`,
				noNetworksAvailable:`¡No hay redes PICOIO disponibles!`,
			}
		},
	},
