export default {
	...
	dashboard:{
		vote:{
			...
			description:`Мы запустили PICO Mainnet Block Producer, за который вы теперь можете голосовать. Помогите нам занять позицию блок продюсера, проголосовав за нас.`,
	...
	receive:{
		...
		forPicoio:`Некоторые биржи попросят вас указать addressTag, memo или другую форму второго поля ввода. Вы можете ввести все что угодно в это поле, так как это настоящий аккаунт PICOIO.`
	},
	...
	editNetwork:{
		...
		systemTokenDescription:`В некоторых сетях вместо системного токена по умолчанию используется собственный системный токен (например, ETH, PICO или TRX).`
	},
	...
	popins:{
		...
		overlay:{
			...
			linkAccount:{
				...
				button:`Связать`,
				noNetworksAvailable:`Нет доступных PICOIO сетей!`,
			}
		},
	},
