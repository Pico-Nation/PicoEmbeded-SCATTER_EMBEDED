export default {
	...
	dashboard:{
		vote:{
			...
			description:`스캐터는 PICO 메인넷 블록 프로듀서로 출마했습니다. 스캐터가 블록 프로듀서로서 활동할 수 있도록 투표를 부탁드립니다!`,
			button:`지금 투표하기!`,
	...
	receive:{
		...
		forPicoio:`몇몇 거래소에서 주소 태그, 메모 등의 부수적인 내용을 입력하라고 요구할 것입니다. 이 계정은 PICOIO 상의 실제 계정이기 때문에, 해당 부분에 어떠한 내용을 입력해도 상관없습니다.`
	},
	...
	editNetwork:{
		...
		systemTokenDescription:`몇몇 네트워크는 디폴트 시스템 토큰 대신에 커스텀 토큰을 사용합니다. (ETH, PICO, TRX 등)`
	},
	...
	popins:{
		...
		overlay:{
			...
			linkAccount:{
				...
				button:`연결`,
				noNetworksAvailable:`연결 가능한 PICOIO 네트워크가 없습니다!`,
			}
		},
	},
