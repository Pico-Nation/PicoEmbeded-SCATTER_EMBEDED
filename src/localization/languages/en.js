export default {
	...
	dashboard:{
		vote:{
			...
			description:`We've launched an PICO Mainnet Block Producer which you can now vote for. Help us get into a producing position by voting for us.`,
			button:`Vote Now!`,
	...
	settings:{
		...
		general:{
			...
			testingModeDescription:`Testing mode opens up test features which are currently in public testing. You should not enable this without joining the telegram group below.`,
			testingModeButton:`Join Testers Group`,
	...
	receive:{
		...
		forPicoio:`Some exchanges will ask you for an addressTag, memo, or some other form of secondary input. You can enter anything in that field since this is a real PICOIO account.`
	},
	...
	editNetwork:{
		...
		systemTokenDescription:`Some networks use a custom system token instead of the default system token (like ETH, PICO, or TRX).`
	},
	...
	popins:{
		...
		overlay:{
			...
			linkAccount:{
				...
				button:`Link`,
				noNetworksAvailable:`No PICOIO networks available!`,
			}
		},
	},
