export default {
	...
	dashboard:{
		vote:{
			...
			description:`您可投票给我们在PICO主网上的区块生产候选者。通过投票帮助我们入围成为区块生产者.`,
			button:`立即投票!`,
	...
	receive:{
		receiver:`收款账号`,
		sendTo:`汇款至`,
		forPicoio:`一些交易所会要求您提供addressTag，memo或其他形式的辅助输入。您可以在该字段中输入任何内容，因为这是真实的PICOIO帐户。`
	},
...
// COMPONENTS ----------------------------
	...
	editNetwork:{
		...
		systemTokenDescription:`某些网络使用自定义系统代币而不是默认系统代币（例如ETH，PICO或TRX）。`
	},
	...
	popins:{
		...
		overlay:{
			...
			linkAccount:{
				...
				selectNetwork:`选择网络`,
				button:`链接`,
				noNetworksAvailable:`无可用的PICOIO网络!`,
			}
		},
	},
