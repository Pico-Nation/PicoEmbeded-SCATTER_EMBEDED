...
export class Popup {
	...
	static picoChangePermissions(account, callback){
		return new Popup(PopupDisplayTypes.POP_IN, new PopupData(PopupTypes.PICO_CHANGE_PERMISSIONS, {account}, callback))
	}

	static picoProxyVotes(account, callback){
		return new Popup(PopupDisplayTypes.POP_IN, new PopupData(PopupTypes.PICO_PROXY_VOTES, {account}, callback))
	}

	static picoModerateRam(account, callback){
		return new Popup(PopupDisplayTypes.POP_IN, new PopupData(PopupTypes.PICO_MODERATE_RAM, {account}, callback))
	}

	static picoModerateCpuNet(account, callback){
		return new Popup(PopupDisplayTypes.POP_IN, new PopupData(PopupTypes.PICO_MODERATE_CPU_NET, {account}, callback))
	}

	static picoCreateAccount(account, callback){
		return new Popup(PopupDisplayTypes.POP_IN, new PopupData(PopupTypes.PICO_CREATE_ACCOUNT, { account }, callback))
	}

	static picoLinkAccount(keypair, callback){
		return new Popup(PopupDisplayTypes.POP_IN, new PopupData(PopupTypes.PICO_LINK_ACCOUNT, { keypair }, callback))
	}
	...
	static checkHardwareWalletScreen(){
		window.wallet.utility.pushNotification('Check Hardware', 'Please check your hardware screen.');
...
export const PopupTypes = {
	...
	PICO_LINK_ACCOUNT:'picoLinkAccount',
	...
	PICO_CHANGE_PERMISSIONS:'picoChangePermissions',
	PICO_PROXY_VOTES:'picoProxyVotes',
	PICO_MODERATE_RAM:'picoModerateRam',
	PICO_MODERATE_CPU_NET:'picoModerateCpuNet',
	PICO_CREATE_ACCOUNT:'picoCreateAccount',
