		...
		return new Promise(resolve => {
			...
			require('@walletpack/core/models/Scatter').default.create().then(fakeScatter => {
				...
				const keypair = require('@walletpack/core/models/Keypair').default.fromJson({
					name:'testkey',
					privateKey:'{test:"key"}',
					publicKeys:[{key:'PICO7w5aJCv5B7y3a6f4WCwPSvs6TpCAoRGnGpiLMsSWbmxaZdKigd', blockchain:'pico'}],
					blockchains:['pico']
				});
				...
				// Taken randomly from a snapshot: https://www.picosnapshots.io/?prefix=data/2018-07/
