        ...
        <section class="fader" :class="{'show':showFader}">
            ...
            <section class="pop-ins" v-for="popIn in popIns">
                <section class="fullscreen" v-if="isFullscreen(popIn)">
                    ...
                    <PicoProxyVotes :popin="popIn" v-if="popIn.data.type === popupTypes.PICO_PROXY_VOTES" />
                    <PicoChangePermissions :popin="popIn" v-if="popIn.data.type === popupTypes.PICO_CHANGE_PERMISSIONS" />
                    <PicoModerateRam :popin="popIn" v-if="popIn.data.type === popupTypes.PICO_MODERATE_RAM" />
                    <PicoModerateCpuNet :popin="popIn" v-if="popIn.data.type === popupTypes.PICO_MODERATE_CPU_NET" />
                    <PicoCreateAccount :popin="popIn" v-if="popIn.data.type === popupTypes.PICO_CREATE_ACCOUNT" />
                ...
                <section class="overlay" :class="{'wide':isWide(popIn)}" v-else>
                    <figure class="bg-holder">
                        <section class="pop-in-over">
                            ...
                            <PicoLinkAccount :popin="popIn" v-if="popIn.data.type === popupTypes.PICO_LINK_ACCOUNT" />
...
<script>
    ...
    import PicoProxyVotes from './popins/fullscreen/PicoProxyVotes'
    import PicoChangePermissions from './popins/fullscreen/PicoChangePermissions'
    import PicoModerateRam from './popins/fullscreen/PicoModerateRam'
    import PicoModerateCpuNet from './popins/fullscreen/PicoModerateCpuNet'
    ...
    import PicoCreateAccount from "./popins/fullscreen/PicoCreateAccount";
    ...
    import PicoLinkAccount from "./popins/overlay/PicoLinkAccount";
